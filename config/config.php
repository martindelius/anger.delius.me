 ...
 * BASIC
 */
$config['site_title'] = 'anger.delius';              // Site title
$config['base_url'] = 'http://anger.delius.me';                    // Override base URL (e.g. http://example.com)

/*
 * THEME
 */
$config['theme'] = 'uikit';                // Set the theme (defaults to "default")
...
$config['puik']['global_sidebar_source'] = 'layout/main_sidebar.html';
